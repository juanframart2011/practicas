            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                #'base_dn' => env('ADLDAP_BASEDN', 'cn=admin,dc=inssoftmx,dc=com'),
                ...
                */
                ...
                #'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'cn=read-only-admin,dc=example,dc=com'),
                #'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'password'),

                'base_dn' => 'dc=inssoftmx,dc=com',
                'domain_controllers' => ['ec2-52-25-19-29.us-west-2.compute.amazonaws.com'],

                'admin_account_prefix' => 'cn=',
                'admin_account_suffix' => ',dc=inssoftmx,dc=com',

                'admin_username' => 'admin',
                'admin_password' => '1nss0ft1',

                'account_prefix' => 'uid=',
                'account_suffix' => ',dc=inssoftmx,dc=com',
